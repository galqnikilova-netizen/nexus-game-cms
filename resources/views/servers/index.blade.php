<x-layouts.app title="Сървъри · NEXUS">
    ...
    <div class="portal-shell portal-page-grid">
        ...
        <main class="portal-page-main">
            <header class="portal-heading"><div><small>SERVER DIRECTORY</small><h2>ACTIVE NETWORK</h2></div><b>{{ $servers->sum('players_online') }} PLAYERS ONLINE</b></header>
